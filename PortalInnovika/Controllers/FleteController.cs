...
namespace PortalInnovika.Controllers
{
    public class FleteController : Controller
    {
        ...
        //----------------------------------------------
        //COSTO DE FLETE EN BASE A REGLAS DE EMPAQUE
        //----------------------------------------------
        public JsonResult CostoFlete(int proyecto)
        {
            CostoFlete costo = new CostoFlete { Costo = 0M };            
        ...
        public int cajasGrandes = 0;
        public int cajasTelescopicas = 0;
        public int cajasChCount = 0;
        public int cajasMdCount = 0;
        public int cajasGdCount = 0;
        public int cajasTlCount = 0;
        ...
        public decimal m2gd = 0;
        public decimal m2tl = 0;
        ...
        private bool EsCajaGrande(decimal ancho, decimal alto)
        {
            if ((ancho <= 700) && (alto <= 1300))
            {
                return true;
            }
            else if ((alto <= 700) && (ancho <= 1300))
            {
                return true;
            }
            else
        ...
        private bool EsCajaTelescopica(decimal ancho, decimal alto)
        {
            if ((ancho <= 60) && (alto <= 2400))
            {
                return true;
            }
            else if ((alto <= 60) && (ancho <= 2400))
            {
                return true;
            }
            else
